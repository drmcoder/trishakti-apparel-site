...
export const capabilities = [
  ...
  },
  {
    ...
    icon: 'check',
    body:
      'In-line and final inspection with attention to stitch quality, measurements, and finish. Every defect is logged digitally to the operation and operator — quality is managed, not hoped for. Compliance-ready and building toward formal audits.',
  },
  {
    key: 'tracking',
...
export const process = [
  ...
  { step: 5, title: 'Produce & inspect', body: 'The approved sample goes to the line. We sew and finish under in-line checks and a final inspection before packing — we welcome your appointed third-party inspector too.' },
