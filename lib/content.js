...
// 87% women workforce (confirmed by Santosh). Nepal grid is predominantly
...
export const sustainability = {
  ...
  highlights: [
    { value: '87%', label: 'of our workforce are women', icon: 'spark' },
  ...
  pillars: [
    {
      ...
      icon: 'spark',
      points: [
        '87% of our team are women — meaningful, skilled employment in Gaindakot.',
